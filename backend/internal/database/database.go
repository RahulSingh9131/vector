// Package database provides PostgreSQL database connectivity and connection pool management.
package database
...
import (
	...
	loggerConfig "github.com/RahulSingh9131/vector/internal/logger"
